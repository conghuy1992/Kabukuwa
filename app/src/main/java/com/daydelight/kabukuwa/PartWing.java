...
public class PartWing extends BaseAdapter {
    Context context;
    ...
    public PartWing(Context context, ArrayList<String> arrID, ArrayList<Integer> arrNum, int horn, ArrayList<Integer> arrUsePart, ArrayList<Integer> soluong) {
